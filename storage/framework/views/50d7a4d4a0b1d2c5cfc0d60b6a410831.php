                ...
                <form method="POST" action="<?php echo e(route('reservas.update', $reserva)); ?>">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" id="nome" name="nome" class="form-control <?php $__errorArgs = ['nome'];
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" id="data_entrada" name="data_entrada" class="form-control <?php $__errorArgs = ['data_entrada'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" id="data_saida" name="data_saida" class="form-control <?php $__errorArgs = ['data_saida'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
